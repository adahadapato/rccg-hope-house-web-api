...
public class UpdateChurchAddressCommandHandler : IRequestHandler<UpdateChurchAddressCommand, ChurchInfoDto>
{
    private readonly IChurchInfoRepository _churchInfoRepository;
    private readonly IMemberRepository _memberRepository;

    public UpdateChurchAddressCommandHandler(
    ...
    public async Task<ChurchInfoDto> Handle(UpdateChurchAddressCommand request, CancellationToken ct)
    {
        ...
        info.UpdateAddress(
            ...
            request.AddressLine2, request.PostCode);
