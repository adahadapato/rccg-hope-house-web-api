...
namespace RccgHopeHouse.Infrastructure.Migrations
{
    ...
    [Migration("20260922011050_RefactorGalleryToFileStorage")]
    partial class RefactorGalleryToFileStorage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RccgHopeHouse.Core.Entities.GivingType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("GivingTypes", (string)null);
                });
            ...
            modelBuilder.Entity("RccgHopeHouse.Core.Entities.Offering", b =>
                {
                    b.HasOne("RccgHopeHouse.Core.Entities.GivingType", "GivingType")
                        .WithMany()
                        .HasForeignKey("GivingTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("GivingType");
                });
